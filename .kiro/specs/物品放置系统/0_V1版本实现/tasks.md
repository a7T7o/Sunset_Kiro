...
- [x] 6. 集成输入系统
  - [x] 6.1 修改 GameInputManager 集成放置系统
    - 检测放置模式
    - 左键触发 TryPlace()
    - 右键/ESC 取消放置
...
- [x] 7. 集成工具栏系统
  - [x] 7.1 修改 HotbarSelectionService 检测可放置物品
    - 手持可放置物品时激活放置模式
    - 切换物品时退出放置模式
    - _Requirements: 1.1, 1.6_

- [x] 8. 添加音效和特效框架
  - [x] 8.1 在 PlacementManager 中添加音效播放框架
    - 放置成功音效字段
    - 放置失败音效字段
    - 撤销音效字段
...
### 遗留 TODO（非阻塞）
- [ ] 与 InventoryService 完整集成（扣除物品、返还物品）
- [ ] 与 FarmingSystem 集成（耕地检测）
- [ ] 配置音效和特效资源
